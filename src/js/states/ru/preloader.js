...
MouseGame.Preloader.prototype = {
    ...
    preload: function () {
        ...
        game.load.image('ending','assets/backgrounds/backgrounds_RU/ending.jpg');
        //
        ...
        game.load.image('logo','assets/buttons/buttons_RU/menu_title.png');
        //
        ...
        game.load.image('title','assets/backgrounds/backgrounds_RU/title.jpg');
        //
