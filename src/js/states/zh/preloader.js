...
MouseGame.Preloader.prototype = {
    ...
    preload: function () {
        ...
        game.load.image('button-mute','assets/buttons/buttons_ZH/mute_audio.png');
        game.load.image('button-unmute','assets/buttons/buttons_ZH/unmute_audio.png');
        ...
        game.load.image('ending','assets/backgrounds/backgrounds_ZH/ending.jpg');
        //
        ...
        game.load.image('title','assets/backgrounds/backgrounds_ZH/title.jpg');
        //
