...
MouseGame.Preloader.prototype = {
    ...
    preload: function () {
        ...
        game.load.image('button-mute','assets/buttons/buttons_JA/mute_audio.png');
        game.load.image('button-unmute','assets/buttons/buttons_JA/unmute_audio.png');
        ...
        game.load.image('ending','assets/backgrounds/backgrounds_JA/ending.jpg');
        //
        ...
        game.load.image('title','assets/backgrounds/backgrounds_JA/title.jpg');
        //
